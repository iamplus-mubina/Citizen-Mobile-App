    ...
    <SafeAreaView className="flex-1 bg-background" edges={['top', 'bottom']}>
      ...
      <View className={containerClass}>
        ...
        <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          {/* Banner Video/Image Placeholder */}
          <View className="w-full h-56 bg-slate-200 items-center justify-center relative">
            <View className="w-16 h-16 bg-black/30 rounded-full items-center justify-center">
              <PlayIcon size={32} color="#ffffff" />
            </View>
            <View className="absolute bottom-2 right-2 bg-black/60 px-2 py-1 rounded">
              <Text className="text-white text-xs font-inter-medium">0:45</Text>
            </View>
          </View>
          ...
          <View className="p-6">
            ...
            <View className="bg-slate-50 p-4 rounded-xl border border-border mt-2">
